...
namespace ValveFileImporter.ValveResourceFormat.Utils
{
    /// <summary>
...
#pragma warning restore CA1032 // Implement standard exception constructors
    {
        ...
        public UnexpectedMagicException(string message, int magic, string? nameofMagic = null) : base(message)
        {
        ...
        /// <param name="magic">The unexpected magic value.</param>
        /// <param name="nameofMagic">The name of the magic parameter.</param>
        public UnexpectedMagicException(string message, uint magic, string? nameofMagic = null) : base(message)
        {
            Magic = $"{magic} (0x{magic:X})";
            MagicNameof = nameofMagic ?? string.Empty;
        }
        ...
        /// <param name="magic">The unexpected magic value.</param>
        /// <param name="nameofMagic">The name of the magic parameter.</param>
        public UnexpectedMagicException(string message, string magic, string? nameofMagic = null) : base(message)
        {
            Magic = magic;
            MagicNameof = nameofMagic ?? string.Empty;
        }
